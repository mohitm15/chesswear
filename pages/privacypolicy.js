    ...
    <section className="text-gray-600 body-font container mx-auto">
      <div className="py-2 lg:py-8 mx-auto font-Rubik">
        ...
        <div className="mx-6 md:mx-12 text-base break-words selection:text-blue-600 selection:bg-blue-200">
          ...
          <h1 className="my-2 font-semibold text-3xl">
            Interpretation and Definitions
          </h1>
          <h2 className="my-2 font-semibold text-2xl">Interpretation</h2>
          <p className="tracking-wide text-lg mb-4">
          ...
          <h2 className="my-2 font-semibold text-2xl">Definitions</h2>
          <p className="tracking-wide text-lg mb-4">For the purposes of this Privacy Policy:</p>
          <ul>
            <li>
              <p className="tracking-wide text-lg mb-4">
            ...
            <li>
              <p className="tracking-wide text-lg mb-4">
                <strong>Company</strong> (referred to as either &quotthe Company&quot,
                &quot We, &quotUs&quot or &quotOur&quot in this Agreement) refers to Codeswear,
                Noida, Uttarpradesh.
              </p>
            </li>
            <li>
            ...
            <li>
              <p className="tracking-wide text-lg mb-4">
                <strong>Website</strong> refers to Chesswear, accessible from{" "}
                <a
                  href="https://www.chesswear.com"
                  rel="external nofollow noopener noreferrer"
                  target="_blank"
                >
                  https://www.chesswear.com
                </a>
              </p>
            </li>
            <li>
          ...
          <h2 className="my-2 font-semibold text-2xl">Types of Data Collected</h2>
          <h3 className="my-2 font-semibold text-xl">Personal Data</h3>
          <p className="tracking-wide text-lg mb-4">
          ...
          <ul>
            <li>
              <p className="tracking-wide text-lg mb-4">Email address</p>
            </li>
            <li>
              <p className="tracking-wide text-lg mb-4">First name and last name</p>
            </li>
            <li>
              <p className="tracking-wide text-lg mb-4">Phone number</p>
            </li>
            <li>
          ...
          <h3 className="my-2 font-semibold text-xl">Usage Data</h3>
          <p className="tracking-wide text-lg mb-4">Usage Data is collected automatically when using the Service.</p>
          <p className="tracking-wide text-lg mb-4">
            Usage Data may include information such as Your Device&quots Internet
          ...
          <p className="tracking-wide text-lg mb-4">
            ...
            is already associated with Your Third-Party Social Media Service&quots
          ...
          <p className="tracking-wide text-lg mb-4">
            ...
            the Company through Your Third-Party Social Media Service&quots account.
          ...
          <ul>
            ...
            <li>
              ...
              on how You can delete Flash Cookies, please read &quotWhere can I
              change the settings for disabling, or deleting local shared
              objects?&quot available at{" "}
              <a
          ...
          <p className="tracking-wide text-lg mb-4">
            Cookies can be &quotPersistent&quot or &quotSession&quot Cookies. Persistent Cookies
            remain on Your personal computer or mobile device when You go
            offline, while Session Cookies are deleted as soon as You close Your
            web browser. Learn more about cookies:{" "}
            <a
          ...
          <ul>
            <li>
              ...
              <p className="tracking-wide text-lg mb-4">Type: Session Cookies</p>
              <p className="tracking-wide text-lg mb-4">Administered by: Us</p>
              <p className="tracking-wide text-lg mb-4">
            ...
            <li>
              ...
              <p className="tracking-wide text-lg mb-4">Type: Persistent Cookies</p>
              <p className="tracking-wide text-lg mb-4">Administered by: Us</p>
              <p className="tracking-wide text-lg mb-4">
          ...
          <h2 className="my-2 font-semibold text-2xl">Use of Your Personal Data</h2>
          <p className="tracking-wide text-lg mb-4">The Company may use Personal Data for the following purposes:</p>
          <ul>
            <li>
              <p className="tracking-wide text-lg mb-4">
            ...
            <li>
              <p className="tracking-wide text-lg mb-4">
                ...
                communication, such as a mobile application&quots push notifications
          ...
          <ul>
            ...
            <li>
              ...
              negotiations of, any merger, sale of Company ass ets, financing,
          ...
          <p className="tracking-wide text-lg mb-4">
            ...
            Company&quots operating offices and in any other places where the
          ...
          <h3 className="my-2 font-semibold text-xl">Business Transactions</h3>
          <p className="tracking-wide text-lg mb-4">
          ...
          <h3 className="my-2 font-semibold text-xl">Law enforcement</h3>
          <p className="tracking-wide text-lg mb-4">
          ...
          <h3 className="my-2 font-semibold text-xl">Other legal requirements</h3>
          <p className="tracking-wide text-lg mb-4">
          ...
          <h2 className="my-2 font-semibold text-3xl">Children&quots Privacy</h2>
          <p className="tracking-wide text-lg mb-4">
          ...
          <p className="tracking-wide text-lg mb-4">
            ...
            require Your parent&quots consent before We collect and use that
            information.
          </p>
          <h2 className="my-2 font-semibold text-2xl">Links to Other Websites</h2>
          <p className="tracking-wide text-lg mb-4">
            Our Service may contain links to other websites that are not
            operated by Us. If You click on a third party link, You will be
            directed to that third party&quots site. We strongly advise You to
          ...
          <p className="tracking-wide text-lg mb-4">
            ...
            Service, prior to the change becoming effective and update the &quotLast
            updated&quot date at the top of this Privacy Policy.
          </p>
          <p className="tracking-wide text-lg mb-4">
          ...
          <h2 className="my-2 font-semibold text-2xl">Contact Us</h2>
          <p className="tracking-wide text-lg mb-4">
          ...
          <ul>
            <li>
              ...
              <a
                href="https://www.chesswear.com/privacy"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://www.chesswear.com/contact
              </a>
            </li>
          </ul>
        </div>
