      ...
      <section className="text-gray-600 body-font">
        <div className="text-black-600 mx-2 md:mx-10 my-2 py-10 font-Rubik">
          ...
          <p className="px-10 py-2 ">
            ...
            conditions. Do not continue to use chesswear.com if you do not agree
          ...
          <p className="px-10 py-2">
            We employ the use of cookies. By accessing chesswear.com, you agreed
            to use cookies in agreement with the Chesswear&quot;s Privacy
          ...
          <p className="px-10 py-2">
            Unless otherwise stated, Chesswear and/or its licensors own the
            intellectual property rights for all material on chesswear.com. All
            intellectual property rights are reserved. You may access this from
            chesswear.com for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>
          <div>
            <p className="mb-4 mx-10 font-semibold">You must not:</p>
            <li className="ml-10">Republish material from chesswear.com</li>
            <li className="ml-10">
              Sell, rent or sub-license material from chesswear.com
            </li>
            <li className="ml-10">
              Reproduce, duplicate or copy material from chesswear.com
            </li>
            <li className="ml-10">Redistribute content from chesswear.com</li>
          </div>
          ...
          <p className="mx-10 my-2 ">
            ...
            Chesswear does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of Chesswear,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, Chesswear
            ...
            Chesswear reserves the right to monitor all Comments and to remove
          ...
          <div>
            ...
            <p className="mx-10 my-2">
              {" "}
              You hereby grant Chesswear a non-exclusive license to use,
          ...
          <p className="px-10 py-2">
            ...
            visibility of the hyperlink compensates the absence of Chesswear;
            ...
            must inform us by sending an e-mail to Chesswear. Please include
          ...
          <div>
            ...
            <p className="ml-10 mt-4">
              No use of Chesswear&quot;s logo or other artwork will be allowed
          ...
          <p className="px-10 py-2">
            We will try our best to confirm 100% of the orders but in an
            uncertain event if we are being not able to fulfil the order, we may
            ...
            obligations under these Terms if such delay or failure is due to any
            cause or conditions beyond our reasonable anticipation or control
            <br />
            ...
            Force Majeure, and shall resume on the date such Force Majeure event
            actually ends, whether or not this is the same as the tentative
            date.
          </p>
